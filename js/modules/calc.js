...
function calc(){
  ...
  if(localStorage.getItem('sex')){
    ...
    document.querySelector('.calculating__choose-item').classList.add('.calculating__choose-item_active');
  }else{
    sex = 'female';
  ...
  function calcTotal(){
    if (!sex||!height||!weight||!age||!ratio){  // проверяем, что все поля заполнены
